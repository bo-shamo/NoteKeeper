...
public class NoteActivityViewModel extends ViewModel {
    ...
    public static final String ORIGINAL_NOTE_TITLE = "com.example.notekeeper.ORIGINAL_TITLE";
    public static final String ORIGINAL_NOTE_TEXT = "com.example.notekeeper.ORIGINAL_TEXT";
