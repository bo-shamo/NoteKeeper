...
public class NoteActivity extends AppCompatActivity {
    ...
    //member class fields are prefix with m
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CourseInfo> adaptedCourses =
                new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, courses );
        adaptedCourses.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        mSpinnerCourses.setAdapter(adaptedCourses);

        //get note out intent extra
    ...
    private void sendEmail() {
        ...
        String text = "Check out what I learn in a pluralsight course \"" +
